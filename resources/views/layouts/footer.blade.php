...
@endguest
<div class="m-4 border-b-2 border-gray-400 ">
    ...
    <div class="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
        ...
        <div>
            ...
            <ul>
                ...
                <li class="mb-4"><a href="#" class="hover:underline">
                    </a><a href="{{ url('/portfolio') }}" target="_blank"
                        class="text-gray-600 hover:underline dark:text-gray-400 hover:text-blue-300">Portfolio
                        Us</a>
                </li>
            </ul>
        </div>
