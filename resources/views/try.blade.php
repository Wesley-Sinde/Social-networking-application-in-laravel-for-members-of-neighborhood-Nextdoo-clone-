                                ...
                                <div class="flex items-center justify-between">
                                    <a href="https://github.com/themesberg/flowbite/blob/main/content/components/sidebar.md"
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab"
                                            data-icon="github" class="w-4 h-4 mr-2" role="img"
                                ...
                                <div class="flex items-end mb-3">
                                    <div class="relative w-full mr-3 revue-form-group">
                                        ...
                                        <input
                                            ...
                                            name="member[email]" id="member_email" required="">
                                    </div>
...
<div class="p-2 px-4 bg-gray-200 rounded-lg shadow dark:bg-slate-900">
    <div
        ...
        @if (isset(Auth::User()->id) && Auth::User()->id == $post->user_id)
            ...
            <div class="z-50 hidden p-2 m-0 text-base list-none bg-gray-100 border rounded shadow dark:bg-gray-900 "
                ...
                <div class="pb-3 ">
                    <button class="inline-flex items-center mx-2 w-7 h-7" type="button"
                        data-modal-toggle="popup-modal-delete" data-tooltip-target="tooltip-delete">
                        <img src="\images\app\delete.png" alt="">
                    </button>
                    <div id="tooltip-delete" role="tooltip"
                        class="absolute z-10 invisible inline-block px-3 text-sm font-medium text-white transition-opacity duration-300 bg-red-600 rounded-lg shadow-sm opacity-0 tooltip">
    ...
    <div class="flex">
        ...
        <div class="right-0 float-right ">
            <example-component :summary='@json($post->reactionSummary())' @auth :reacted='@json($post->reacted())'
                @endauth />
        </div>
    </div>
    {{-- Main Body md:flex --}}

    <div class=" py-8 md:py-10 lg:py-8 border-t border-gray-50   mx-2 mt-2 md:flex">
        <div class=" mr-2">
            <img src="{{ asset('images/' . $post->image_path) }}" alt="{{ $post->image_path }}"
                class="mx-auto w-32" />
        ...
        <div>
                    ...
                    @if ($post->discount > 0)
                        <span>
                            <span class="font-bold text-gray-900 dark:text-white">
                                Now Ksh
                                <span class="text-xl"></span>{{ ' ' . ($post->price - $post->discount) }}
                            </span>
            ...
            <div>
                <div>
                    <div class=" pt-10 align-baseline right-3 bottom-3">
                        @if ($post->price == 0)
                            <a class="mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800  right-3 bottom-3"
                                href="images/{{ $post->image_path }}" download="{{ $post->image_path }}">
                                Download
                            </a>
                        @else
                            <a href="#"
                    ...
                    <postcomments-component :user_id={{ Auth::user() ? Auth::user()->id : null }}
                        :postid={{ $post->id }} :view_count={{ $post->view_count }} />
                </div>
